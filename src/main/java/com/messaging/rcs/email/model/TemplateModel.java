...
public class TemplateModel {
	...
	public String toString() {
		return "TemplateModel [id=" + id + ", templateCode=" + templateCode + ", templateJson=" + templateJson
				...
				+ ", msgType=" + msgType + ", rcsMsgTypeId=" + rcsMsgTypeId + ", operatorResponse=" + operatorResponse
				+ ", approveResponse=" + approveResponse + ", userBotMappingId=" + userBotMappingId + ", videoId="
				+ videoId + ", mediaUrl=" + mediaUrl + ", thumbnailUrl=" + thumbnailUrl + ", operator=" + operator
