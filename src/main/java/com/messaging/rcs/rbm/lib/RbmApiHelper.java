 ...
 * the License.
 */
package com.messaging.rcs.rbm.lib;
...
public class RbmApiHelper {
    ...
    private void initCredentials(String credentialsFileLocation) {
        ...
        try {
           ...
           // File file = new File("/opt/rcsmessaging/rbm-agent-service-account-credentials.json");
    ...
    public CardContent createCardContent(String title,
        ...
        System.out.println("Saurabh have to build card from bottom up, starting with the media: imageUrl:"+imageUrl);
        if(imageUrl != null) {
            ...
            System.out.println("Attach media to the card content");
            cardContent.setMedia(media);
        } else {
            System.out.println("Saurabh no Image");
        }
    ...
    public StandaloneCard createStandaloneCard(String title,
        ...
        System.out.println("Saurabh create the card content representation of the parameters");
